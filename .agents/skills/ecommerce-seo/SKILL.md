---
name: ecommerce-seo
description: Comprehensive e-commerce SEO and Generative Engine Optimization (GEO) strategies covering URL architecture, Schema.org markup, technical SEO, and content requirements.
risk: safe
